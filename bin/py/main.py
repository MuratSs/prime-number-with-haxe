...
class Step:
    _hx_class_name = "Step"
    __slots__ = ("end", "step", "index")
    _hx_fields = ["end", "step", "index"]
...
class Main:
    ...
    def main():
        ...
        _g_end = LIMIT
        _g_step = 2
        while ((_g_end >= _g_index) if ((_g_step > 0)) else (_g_index >= _g_end)):
            def _hx_local_1():
                nonlocal _g_index
                _g_index = (_g_index + _g_step)
                return _g_index
            a = ((_hx_local_1()) - _g_step)
            flag = 0
            _g_head = primes.h
            while (_g_head is not None):
                ...
                i = val
                if (HxOverrides.mod(a, i) == 0):
                    flag = 1
                    break
            if (flag == 0):
                primes.add(a)
                count = (count + 1)
        _hx_str = Std.string(count)
